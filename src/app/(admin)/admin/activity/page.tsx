...
const EVENT_TYPE_COLORS: Record<string, string> = {
  "business.created": "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400",
  "product.created": "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400",
  "product.published": "bg-cyan-100 text-cyan-800 dark:bg-cyan-900/30 dark:text-cyan-400",
  "order.completed": "bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400",
  "order.created": "bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400",
  "storefront.published": "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400",
  "user.signed_up": "bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-400",
  "subscription.created": "bg-pink-100 text-pink-800 dark:bg-pink-900/30 dark:text-pink-400",
};
